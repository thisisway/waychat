...
const dict = {
  'pt-BR': {
    ...
    tooLarge: 'Arquivo grande demais (máx. 10 MB)',
    scanFailed: 'Não foi possível verificar o arquivo',
    download: 'Baixar',
  },
  en: {
    open: 'Open chat',
    ...
    scanFailed: 'Could not verify the file',
    download: 'Download',
  },
  es: {
    open: 'Abrir chat',
    ...
    scanFailed: 'No fue posible verificar el archivo',
    download: 'Descargar',
  },
} as const;
