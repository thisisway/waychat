...
Status: **em execução** — passos 1 (banco) e 2 (contatos, inboxes, chaves de API) concluídos. (O responsável delegou as decisões em aberto: "faça como achar melhor"; elas estão registradas abaixo.)
